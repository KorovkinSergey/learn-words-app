...
const SortNewWordsPage = () => {
	...
	return (
		...
		>
			...
			>
				<Button size='large' variant='contained' startIcon={<DoneIcon />} onClick={handleIsKnow} color='success'>
					Знаю
				</Button>
				<Button size='large' variant='contained' startIcon={<ClearIcon />} onClick={handleIsNotKnow} color='error'>
					Не знаю
				</Button>
			</Box>
		</Box>
