...
function TrainingNewWordsSettingsPage() {
  const navigate = useNavigate()
  const { timeToRemember, countWords, setCountWords, setTimeToRemember } = useSettingsNewWordsContext()
...
export default TrainingNewWordsSettingsPage
